...
#For this path we need to add the include dir as well
IF( DEFINED ENV{THRIFT_ROOT} )
    GET_FILENAME_COMPONENT(INCLUDE_ROOT $ENV{THRIFT_ROOT}/include REALPATH)
    LIST( APPEND THRIFT_INCLUDE_DIR ${INCLUDE_ROOT} )
    MESSAGE (" Adding to.." ${THRIFT_INCLUDE_DIR})
ENDIF()
